...
export const StaggeredMenu = ({
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const quarterLandingSection = viewportHeight / 4;
      
      setScrolled(scrollPosition > quarterLandingSection);
    };
    ...
    >
      ...
      >
        ...
        <aside
          ...
          ref={panelRef}
          className={`staggered-menu-panel absolute top-0 right-0 h-full bg-black/90 flex flex-col p-[6em_2em_2em_2em] overflow-y-auto z-10 backdrop-blur-[12px] ${open ? 'pointer-events-auto' : 'pointer-events-none'}`}
...
.sm-scope .staggered-menu-panel { position: absolute; top: 0; right: 0; width: clamp(260px, 38vw, 420px); height: 100%; background: rgba(0, 0, 0, 0.5); backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px); display: flex; flex-direction: column; padding: 6em 2em 2em 2em; overflow-y: auto; z-index: 10; }
