    ...
    >
      ...
      >
        ...
        <aside
          ...
          ref={panelRef}
          className={`staggered-menu-panel absolute top-0 right-0 h-full bg-black/90 flex flex-col p-[6em_2em_2em_2em] overflow-y-auto z-10 backdrop-blur-md ${open ? 'pointer-events-auto' : 'pointer-events-none'}`}
