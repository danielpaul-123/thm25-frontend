...
const Footer = () => {
  return (
    <>
      <footer className="relative z-10 bg-transparent pb-5 pt-20 lg:pb-10 lg:pt-[120px]">
            ...
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="mb-10 w-full">
                ...
                <p className="mb-7 text-base text-body-color dark:text-dark-6">
                  For any questions, collaboration ideas, or further details, get in touch with the THM 2025 organising team via our website contact form or email.
                </p>
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-2/12" style={{ pointerEvents: 'auto' }}>
              <div className="mb-10 w-full">
                ...
                <ul className="space-y-3">
                  <li>
                    <Link to="/" className="inline-block text-base leading-loose text-body-color hover:text-primary dark:text-dark-6 cursor-pointer transition-colors duration-200">
                      SaaS Development
                    </Link>
                  </li>
                  <li>
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-2/12" style={{ pointerEvents: 'auto' }}>
              <div className="mb-10 w-full">
                ...
                <ul className="space-y-3">
                  ...
                  <li>
                    <Link to="/contact" className="inline-block text-base leading-loose text-body-color hover:text-primary dark:text-dark-6 cursor-pointer transition-colors duration-200">
                      Contact & Support
                    </Link>
                  </li>
                  <li>
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-2/12" style={{ pointerEvents: 'auto' }}>
              <div className="mb-10 w-full">
                ...
                <ul className="space-y-3">
                  ...
                  <li>
                    <Link to="/about" className="inline-block text-base leading-loose text-body-color hover:text-primary dark:text-dark-6 cursor-pointer transition-colors duration-200">
                      Know Our Team
                    </Link>
                  </li>
                  <li>
